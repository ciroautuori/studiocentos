    ...
    <div class="p-6">
      ...
      <div v-if="!isValidId" class="rounded-md bg-red-50 p-4 mb-6">
        <div class="flex">
          ...
          <div class="ml-3">
            <h3 class="text-sm font-medium text-red-800">Invalid event ID. Please return to the events list and try again.</h3>
          </div>
        </div>
      </div>
...
import EventForm from '../../../components/section/events/EventForm.vue';
...
const isValidId = computed(() => eventId.value !== null);

const pageTitle = computed(() => 'Edit Event');
