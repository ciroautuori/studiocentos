  ...
  <div class="min-h-screen bg-[#0b2a63]/5">
        ...
        <div class="max-w-4xl mx-auto py-24">
          <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              I Nostri <span class="text-red-600">Eventi</span>
            </h1>
            <p class="text-xl text-gray-200 mb-8 leading-relaxed">
              Scopri tutti gli eventi e le iniziative per promuovere l'inclusione sociale
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto px-4 lg:px-8 py-12">
      ...
      <div v-if="loading" class="text-center py-16">
        ...
        <p class="mt-4 text-lg text-[#0b2a63]">Caricamento eventi...</p>
      </div>
      ...
      <div v-else-if="filteredEvents.length === 0" class="text-center py-16">
        <div class="bg-white p-8 rounded-xl shadow-lg max-w-xl mx-auto">
          ...
          <h3 class="text-xl font-bold text-[#0b2a63] mb-2">Nessun evento trovato</h3>
          <p class="text-gray-600 mb-6">
            {{ searchQuery || statusFilter ? 'Nessun evento corrisponde ai criteri di ricerca.' : 'Non ci sono eventi disponibili al momento.' }}
          </p>
          <button
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold text-[#0b2a63] mb-3 group-hover:text-[#0b2a63]/80 transition-colors duration-300">{{ event.title }}</h3>
            <p class="text-gray-600 mb-4 line-clamp-3">{{ event.description }}</p>

            <div class="flex items-center text-sm text-gray-500 mb-4" v-if="event.created_at">
      ...
      <!-- Pagination -->
      <div v-if="!loading && !error && filteredEvents.length > 0" class="mt-12 flex justify-center">
        <button
...
// Filtraggio eventi basato su ricerca e stato
  ...
  if (statusFilter.value) {
    filtered = filtered.filter(event => {
      if (statusFilter.value === 'In corso') {
        ...
        return event.is_featured === false;
      }
      return true;
    });
  }
